...
fn run_model_integration_test(model_id: &str, expected_dim: usize) -> Result<(), Box<dyn std::error::Error>> {
...
#[test]
fn test_openai() -> Result<(), Box<dyn std::error::Error>> {
    run_model_integration_test(OPENAI_MODEL_ID, 512)
}

#[test]
fn test_laion() -> Result<(), Box<dyn std::error::Error>> {
    run_model_integration_test(LAION_MODEL_ID, 512)
}

#[test]
fn test_mobileclip() -> Result<(), Box<dyn std::error::Error>> {
    run_model_integration_test(MOBILECLIP2_MODEL_ID, 512)
}

#[test]
fn test_siglip1() -> Result<(), Box<dyn std::error::Error>> {
    run_model_integration_test(SIGLIP1_MODEL_ID, 1152)
}

#[test]
fn test_siglip2() -> Result<(), Box<dyn std::error::Error>> {
